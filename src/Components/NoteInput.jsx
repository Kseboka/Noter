  ...
  return (
    <div className="note-input-field">
      <form className="note-input-card">
        <input onChange={handleInputChange} type="text" name="title" placeholder="Title" value={title} />
        <textarea onChange={handleInputChange} cols="30" rows="5" name="content" placeholder="Take a note..." value={content} />
        {inputError && (
